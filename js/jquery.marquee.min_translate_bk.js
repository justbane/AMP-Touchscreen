        ...
        return this.each(function() {
            ...
            var A = function() {
                i.css("margin-top", n.direction == "up" ? b + "px" : "-" + w + "px")
                    ...
                    i.css("transform", n.direction == "left" ? "translateX(" + s + "px)" : "translateX(-" + a + "px)")
                };
            if (n.duplicated) {
                if (u) {
                    i.css("margin-top", n.direction == "up" ? b : "-" + (w * 2 - n.gap) + "px")
                } else {
                    i.css("transform", n.direction == "left" ? "translateX(" + s + "px)" : "translateX(-" + (a * 2 - n.gap) + "px)")
                }
                f = 1
            } else {
                if (u) {
            ...
            var M = function() {
                ...
                if (u) {
                    ...
                    if (n.duplicated) {
                        if (f > 2) {
                            i.css("transform", n.direction == "left" ? "translateX(" + 0 + ")" : "translateX(-" + a + "px)")
                        }
                        o = {
                            "transform": n.direction == "left" ? "translateX(-" + a + "px)" : "translateX(" + 0 + ")"
                        }
                    } else {
                        O();
                        o = {
                            "transform": n.direction == "left" ? "translateX(-" + a + "px)" : "translateX(" + s + "px)"
                        }
                    }
                }
